...
ERROR_NOT_TREATMENT = (
    "Ocorreu algo que não esperavamos e para seu conforto estaremos olhando."
)
...
ERROR_FAIL_DATA_ACQUISITION = "Exception: fail to get data, the data came empty, verify if is all ok with your request."
